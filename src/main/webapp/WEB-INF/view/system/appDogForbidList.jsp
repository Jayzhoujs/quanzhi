            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="system/updateDogFor" method="post" id="form-wiz" target="iframe_display">
                                ...
                                <div class="span11 field-box actions" style='margin-top:-100px;'>
                            ...
                            <div hidden="true" id="tempDetail">${dfm.detail}</div> 
                        </div>
                    </div>
                </div>
            </div>
     ...
     //富文本加載
          ...
          //进入后加载已有页面信息进入富文本编辑器
            ...
            $("#submitForm").click(function(){
            	var activityHtml = editor.$txt.html().trim(); 
	            $("#activityHTML").val(activityHtml);
        		$.post("system/updateDogFor",{detail:activityHtml},function(data){
				debugger
        			if (data.status=='ok') {
        				swal({
        					title : "成功！",
        					...
        					window.location.href = 'system/allDogForbidden';
        				});
        			} else {

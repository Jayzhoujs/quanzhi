            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="system/updateProcess" method="post" id="form-wiz" target="iframe_display">
     ...
     //富文本加載
          ...
          //进入后加载已有页面信息进入富文本编辑器
            ...
            $("#submitForm").click(function(){
            	var activityHtml = editor.$txt.html().trim(); 
	            $("#activityHTML").val(activityHtml);
        		$.post("system/updateProcess",{detail:activityHtml},function(data){
        			if (data.status=='ok') {
        				swal({
        					title : "成功！",
        					type : "success",
        					...
        					window.location.href = 'system/getProcess';
        				});
        			} else {

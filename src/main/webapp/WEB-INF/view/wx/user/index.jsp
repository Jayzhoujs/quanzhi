	...
	<section class="scrollWrap">	<!--自适应滚动条-->
		...
		<div class="weui-flex">
		  <div class="weui-flex__item">
			...
			<div class="weui-flex__item">
				<a href="#" class="">
			    <div class="icon">
			      <img src="./img/index_icon_04.png" alt="">
			    </div>
			    <p class="text">
						在线举报
			    </p>
		...
		<div class="weui-cells">
			 <c:forEach items="${data.newList}" var="news">
			  <a class="weui-cell weui-cell_access" href="wx/news_detail">
			    <div class="weui-cell__bd">
			      <p>${news.title}</br>${news.abstracts}</p>
			    </div>
			    <div class="weui-cell__ft">${news.createTime}</div>
			  </a>
			  </c:forEach>

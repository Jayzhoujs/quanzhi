...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        $table.on('click', 'td', function (e) {
            ...
            for (i = 0; i < rownum; i++) {
            	if(i==0){ 
            		tableHtml += '<tr style="text-align: center;background-color: red;color:white;border-bottom-color: white">'; 
                    for (j = 0; j < colnum; j++) {
                    ...
                    for (j = 0; j < colnum; j++) {
                        for (j = 0; j < colnum; j++) {
                        	if(j%2!=0){
                        		tableHtml += '<td style="background-color: #F7E5D7;border-bottom:1px solid white"><span>&nbsp;</span></td>';
                        	}else{
                        		tableHtml += '<td style="background-color: #FCF3E2;border-bottom:1px solid white"><span>&nbsp;</span></td>';
                        	}
                        }    
                    } 
                    tableHtml += '</tr>';
